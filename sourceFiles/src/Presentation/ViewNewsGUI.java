...
//		masterPanel.add(northPanel, BorderLayout.NORTH);
	 ...
	 */
	public ViewNewsGUI(String theNews){
		listener = new ViewNewsListener();
		doneButton = new JButton("Done");
...
//		frame.setUndecorated(true);
		...
		frame.setResizable(false); 		//user can't resize GUI on their own
		frame.setSize(645,633);			//set size of this
		frame.getContentPane().setLayout(null);
		southPanel.setBounds(10, 547, 616, 42);
		southPanel.setLayout(new FlowLayout());
		southPanel.add(doneButton);
		
		theText = new JTextArea(theNews);
		scroll = new JScrollPane(theText);
		scroll.setBounds(10, 11, 616, 525);
		theText.setEditable(false);
		masterPanel.setBounds(0, 0, 794, 771);
