...
public class ViewReservationListGUI {
	...
	private ViewReservationListListener listener;
	
	public class ViewReservationListListener implements ActionListener{
		@Override
...
//				getFrame().dispatchEvent(new WindowEvent(getFrame(), WindowEvent.WINDOW_CLOSING));
	...
	public ViewReservationListGUI(){
		
		
		listener = new ViewReservationListListener();
		...
		//create GUI
		frame = new JFrame();
		frame.setTitle("reservation list");
	 ...
	 */
	public ViewReservationListGUI(String theReservationList){
		listener = new ViewReservationListListener();
		doneButton = new JButton("Done");
...
//		frame.setUndecorated(true);
		...
		theText.setText(theReservationList);
